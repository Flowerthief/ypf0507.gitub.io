    !function webpackUniversalModuleDefinition(t, e) {
        ...
        var __webpack_modules__ = [, (t, e) => {
            ...
            e.bytesToString = function bytesToString(t) {
                ...
                const n = [];
                for (let i = 0; i < e; i += s) {
                    const a = Math.min(i + s, e), r = t.subarray(i, a);
            ...
            e.stringToPDFString = function stringToPDFString(t) {
                if (t[0] >= "ï") {
                    ...
                    if (e) try {
                        const s = new TextDecoder(e, {fatal: !0}), n = stringToBytes(t);
                        return s.decode(n)
                    } catch (t) {
            ...
            function shadow(t, e, s, n = !1) {
                Object.defineProperty(t, e, {value: s, enumerable: !n, configurable: !0, writable: !1});
                return s
            }
            ...
            class Util {
                ...
                static getAxialAlignedBoundingBox(t, e) {
                    const s = Util.applyTransform(t, e), n = Util.applyTransform(t.slice(2, 4), e),
                        i = Util.applyTransform([t[0], t[3]], e), a = Util.applyTransform([t[2], t[1]], e);
                ...
                static singularValueDecompose2dScale(t) {
                    const e = [t[0], t[2], t[1], t[3]], s = t[0] * e[0] + t[1] * e[2], n = t[0] * e[1] + t[1] * e[3],
                        i = t[2] * e[0] + t[3] * e[2], a = t[2] * e[1] + t[3] * e[3], r = (s + a) / 2,
                        o = Math.sqrt((s + a) ** 2 - 4 * (s * a - i * n)) / 2, l = r + o || 1, c = r - o || 1;
            ...
            var _util = __w_pdfjs_require__(1), _annotation_storage = __w_pdfjs_require__(3),
                _display_utils = __w_pdfjs_require__(6), _font_loader = __w_pdfjs_require__(9),
                _canvas = __w_pdfjs_require__(11), _worker_options = __w_pdfjs_require__(14),
                _is_node = __w_pdfjs_require__(10), _message_handler = __w_pdfjs_require__(15),
                _metadata = __w_pdfjs_require__(16), _optional_content_config = __w_pdfjs_require__(17),
                _transport_stream = __w_pdfjs_require__(18), _xfa_text = __w_pdfjs_require__(19);
            ...
            if (_is_node.isNodeJS) {
                ...
                const {PDFNetworkStream: t} = __w_pdfjs_require__(24), {PDFFetchStream: e} = __w_pdfjs_require__(25);
                createPDFNetworkStream = s => (0, _display_utils.isValidFetchUrl)(s.url) ? new e(s) : new t(s)
            }

            function getDocument(t) {
                if ("string" == typeof t || t instanceof URL) t = {url: t}; else if ((0, _util.isArrayBuffer)(t)) t = {data: t}; else if (t instanceof PDFDataRangeTransport) {
                ...
                const e = new PDFDocumentLoadingTask, s = t.url ? getUrlProp(t.url) : null,
                    n = t.data ? getDataProp(t.data) : null, i = t.httpHeaders || null, a = !0 === t.withCredentials,
                    r = t.password ?? null, o = t.range instanceof PDFDataRangeTransport ? t.range : null,
                ...
                const h = t.verbosity,
                    ...
                    u = "string" == typeof t.cMapUrl ? t.cMapUrl : null, p = !1 !== t.cMapPacked,
                    g = t.CMapReaderFactory || DefaultCMapReaderFactory,
                    f = "string" == typeof t.standardFontDataUrl ? t.standardFontDataUrl : null,
                    m = t.StandardFontDataFactory || DefaultStandardFontDataFactory, b = !0 !== t.stopAtErrors,
                    ...
                    S = !0 === t.fontExtraProperties, x = !0 === t.enableXfa,
                    E = t.ownerDocument || globalThis.document, C = !0 === t.disableRange, P = !0 === t.disableStream,
                    T = !0 === t.disableAutoFetch, w = !0 === t.pdfBug, k = o ? o.length : t.length ?? NaN,
                ...
                if (!c) {
                    const t = {verbosity: h, port: _worker_options.GlobalWorkerOptions.workerPort};
                ...
                c.promise.then((function () {
                    ...
                    const t = _fetchDocument(c, I), r = new Promise((function (t) {
                        let e;
            ...
            class PDFPageProxy {
                ...
                render({
                    ...
                    const p = a || new DefaultCanvasFactory({ownerDocument: this._ownerDocument}),
                    ...
                    if (!u.displayReadyCapability) {
                        ...
                        u.operatorList = {fnArray: [], argsArray: [], lastChunk: !1, separateAnnots: null};
                    ...
                    const complete = t => {
                        ...
                        if (t) {
                            ...
                            this._abortOperatorList({intentState: u, reason: t instanceof Error ? t : new Error(t)})
                        } else f.capability.resolve();
                        this._stats?.timeEnd("Rendering");
                        this._stats?.timeEnd("Overall")
                    }, f = new InternalRenderTask({
                        callback: complete,
                        params: {canvasContext: t, viewport: e, transform: i, background: r},
                        objs: this.objs,
                    ...
                    Promise.all([u.displayReadyCapability.promise, o]).then((([t, e]) => {
                        if (this.pendingCleanup) complete(); else {
                            ...
                            f.initializeGraphics({transparency: t, optionalContentConfig: e});
                ...
                getTextContent(t = {}) {
                    ...
                    return new Promise((function (t, s) {
                        const n = e.getReader(), i = {items: [], styles: Object.create(null)};
                        !function pump() {
                ...
                _destroy() {
                    ...
                    for (const e of this._intentStates.values()) {
                        ...
                        if (!e.opListReadCapability) for (const s of e.renderTasks) {
                            t.push(s.completed);
                            s.cancel()
                        }
                    }
                ...
                _pumpOperatorList({renderingIntent: t, cacheKey: e, annotationStorageMap: s}) {
                    const n = this._transport.messageHandler.sendWithStream("GetOperatorList", {
                        ...
                        cacheKey: e,
                        annotationStorage: s
                    }).getReader(), i = this._intentStates.get(e);
                    i.streamReader = n;
                    const pump = () => {
                        n.read().then((({value: t, done: e}) => {
                            if (e) i.streamReader = null; else if (!this._transport.destroyed) {
                ...
                _abortOperatorList({intentState: t, reason: e, force: s = !1}) {
                    if (t.streamReader) {
                        ...
                        t.streamReader = null;
                        if (!this._transport.destroyed) {
                            for (const [e, s] of this._intentStates) if (s === t) {
                ...
                _initialize() {
                    if (!PDFWorkerUtil.isWorkerDisabled && !PDFWorker._mainThreadWorkerMessageHandler) {
                        ...
                        try {
                            ...
                            const e = new Worker(t), s = new _message_handler.MessageHandler("main", "worker", e),
                                terminateEarly = () => {
            ...
            class WorkerTransport {
                ...
                getRenderingIntent(t, e = _util.AnnotationMode.ENABLE, s = null, n = !1) {
                    let i = _util.RenderingIntentFlag.DISPLAY, a = null;
                    switch (t) {
                        case"any":
                ...
                setupMessageHandler() {
                    ...
                    t.on("ReaderHeadersReady", (t => {
                        const s = (0, _util.createPromiseCapability)(), n = this._fullReader;
                        n.headersReady.then((() => {
                    ...
                    t.on("commonobj", (([e, s, n]) => {
                        if (!this.destroyed && !this.commonObjs.has(e)) switch (s) {
                            case"Font":
                                ...
                                this.fontLoader.bind(r).catch((s => t.sendWithPromise("FontFallback", {id: e}))).finally((() => {
                ...
                getMetadata() {
                    const t = "GetMetadata", e = this.#a.get(t);
                    if (e) return e;
            ...
            class PDFObjects {
                ...
                #h(t) {
                    const e = this.#c[t];
                    return e || (this.#c[t] = {capability: (0, _util.createPromiseCapability)(), data: null})
                }
            ...
            class InternalRenderTask {
                ...
                initializeGraphics({transparency: t = !1, optionalContentConfig: e}) {
                    ...
                    this.gfx = new _canvas.CanvasGraphics(s, this.commonObjs, this.objs, this.canvasFactory, {optionalContentConfig: e}, this.annotationCanvasMap, this.pageColors);
            ...
            class AnnotationStorage {
                ...
                remove(t) {
                    ...
                    if ("function" == typeof this.onAnnotationEditor) {
                        for (const t of this.#g.values()) if (t instanceof i.AnnotationEditor) return;
                        this.onAnnotationEditor(null)
                    }
                }
                ...
                setValue(t, e) {
                    ...
                    let n = !1;
                    if (void 0 !== s) {
                        for (const [t, i] of Object.entries(e)) if (s[t] !== i) {
                            n = !0;
                            s[t] = i
                        }
                    } else {
            ...
            class AnnotationEditor {
                ...
                get parentDimensions() {
                    const {realScale: t} = this._uiManager.viewParameters, [e, s] = this.pageDimensions;
                    return [e * t, s * t]
                }
                ...
                fixDims() {
                    const {style: t} = this.div, {height: e, width: s} = t, n = s.endsWith("%"), i = e.endsWith("%");
                    if (n && i) return;
                ...
                getRect(t, e) {
                    const s = this.parentScale, [n, i] = this.pageDimensions, [a, r] = this.pageTranslation, o = t / s,
                        l = e / s, c = this.x * n, h = this.y * i, d = this.width * n, u = this.height * i;
                ...
                static deserialize(t, e, s) {
                    const n = new this.prototype.constructor({parent: e, id: e.getNextId(), uiManager: s});
            ...
            class CommandManager {
                ...
                add({cmd: t, undo: e, mustExec: s, type: n = NaN, overwriteIfSameType: i = !1, keepUndo: a = !1}) {
                    ...
                    const o = this.#T + 1;
                    if (o === this.#P) this.#E.splice(0, 1); else {
                        this.#T = o;
            ...
            class KeyboardManager {
                constructor(t) {
                    ...
                    for (const [s, n] of t) for (const t of s) {
            ...
            class AnnotationEditorUIManager {
                ...
                constructor(t, e, s) {
                    ...
                    this.#F = s;
                    this.viewParameters = {realScale: i.PixelsPerInch.PDF_TO_CSS_UNITS, rotation: 0}
                }
                ...
                #at(t) {
                    this.#N.dispatch("annotationeditorparamschanged", {source: this, details: t})
                }
                ...
                updateToolbar(t) {
                    t !== this.#B && this.#N.dispatch("switchannotationeditormode", {source: this, mode: t})
                }
                ...
                addCommands(t) {
                    this.#D.add(t);
                    this.#it({hasSomethingToUndo: !0, hasSomethingToRedo: !1, isEmpty: this.#rt()})
                }
                ...
                unselectAll() {
                    if (this.#k) this.#k.commitOrRemove(); else if (0 !== this.#q.size) {
            ...
            e.getXfaPageViewport = function getXfaPageViewport(t, {scale: e = 1, rotation: s = 0}) {
                const {width: n, height: i} = t.attributes.style, a = [0, 0, parseInt(n), parseInt(i)];
            ...
            e.setLayerDimensions = function setLayerDimensions(t, e, s = !1, n = !0) {
                if (e instanceof PageViewport) {
                    const {pageWidth: n, pageHeight: i} = e.rawDims, {style: a} = t,
                        r = `calc(var(--scale-factor) * ${n}px)`, o = `calc(var(--scale-factor) * ${i}px)`;
            ...
            e.StatTimer = class StatTimer {
                ...
                toString() {
                    ...
                    for (const {name: s, start: n, end: i} of this.times) t.push(`${s.padEnd(e)} ${i - n}ms\n`);
                    return t.join("")
                }
            };
            ...
            var n = s(1);
            const i = 3285377520, a = 4294901760, r = 65535;
            e.MurmurHash3_64 = class MurmurHash3_64 {
                ...
                update(t) {
                    ...
                    const i = s >> 2, o = s - 4 * i, l = new Uint32Array(e.buffer, 0, i);
                    let c = 0, h = 0, d = this.h1, u = this.h2;
                    const p = 3432918353, g = 461845907, f = 11601, m = 13715;
                    for (let t = 0; t < i; t++) if (1 & t) {
                        c = l[t];
                        c = c * p & a | c * f & r;
                        c = c << 15 | c >>> 17;
                        c = c * g & a | c * m & r;
            ...
            e.FontLoader = class FontLoader {
                ...
                _queueLoadingCallback(t) {
                    const {loadingRequests: e} = this, s = {
            ...
            e.FontFaceObject = class FontFaceObject {
                ...
                createFontFaceRule() {
                    if (!this.data || this.disableFontFace) return null;
                    const t = (0, n.bytesToString)(this.data), e = `url(data:${this.mimetype};base64,${btoa(t)});`;
                    let s;
                    if (this.cssFontInfo) {
            ...
            var n = s(1), i = s(6), a = s(12), r = s(13);
            const o = 4096, l = 1e3, c = 16;
            ...
            function drawImageAtIntegerCoords(t, e, s, n, a, r, o, l, c, h) {
                ...
                if (0 === u && 0 === p) {
                    const i = o * d + f, b = Math.round(i), A = l * g + m, _ = Math.round(A), v = (o + c) * d + f,
                        y = Math.abs(Math.round(v) - b) || 1, S = (l + h) * g + m, x = Math.abs(Math.round(S) - _) || 1;
                ...
                if (0 === d && 0 === g) {
                    const i = l * p + f, b = Math.round(i), A = o * u + m, _ = Math.round(A), v = (l + h) * p + f,
                        y = Math.abs(Math.round(v) - b) || 1, S = (o + c) * u + m, x = Math.abs(Math.round(S) - _) || 1;
            ...
            class CanvasExtraState {
                ...
                updateRectMinMax(t, e) {
                    const s = n.Util.applyTransform(e, t), i = n.Util.applyTransform(e.slice(2), t);
                ...
                getPathBoundingBox(t = a.PathType.FILL, e = null) {
                    ...
                    if (t === a.PathType.STROKE) {
                        ...
                        const t = n.Util.singularValueDecompose2dScale(e), i = t[0] * this.lineWidth / 2,
            ...
            function putBinaryImageData(t, e, s = null) {
                ...
                const i = e.height, a = e.width, r = i % c, o = (i - r) / c, l = 0 === r ? o : o + 1,
                ...
                if (e.kind === n.ImageKind.GRAYSCALE_1BPP) {
                    const e = p.byteLength, s = new Uint32Array(g.buffer, 0, g.byteLength >> 2), i = s.length,
                        A = a + 7 >> 3;
                    let _ = 4294967295, v = n.FeatureTest.isLittleEndian ? 4278190080 : 255;
            ...
            function putBinaryImageMask(t, e) {
                ...
                const s = e.height, n = e.width, i = s % c, a = (s - i) / c, o = 0 === i ? a : a + 1,
                    l = t.createImageData(n, c);
                let h = 0;
                const d = e.data, u = l.data;
                for (let e = 0; e < o; e++) {
                    const s = e < a ? c : i;
                    ({srcPos: h} = (0, r.applyMaskImageData)({src: d, srcPos: h, dest: u, width: n, height: s}));
            ...
            const h = ["butt", "round", "square"], d = ["miter", "round", "bevel"], u = {}, p = {};
            ...
            class CanvasGraphics {
                ...
                beginDrawing({transform: t, viewport: e, transparency: s = !1, background: n = null}) {
                    const a = this.ctx.canvas.width, r = this.ctx.canvas.height, o = n || "#ffffff";
                    this.ctx.save();
                    if (this.foregroundColor && this.backgroundColor) {
                        ...
                        if ("#000000" === t && "#ffffff" === e || t === e || !s) this.foregroundColor = this.backgroundColor = null; else {
                ...
                executeOperatorList(t, e, s, i) {
                    ...
                    for (; ;) {
                        ...
                        g = r[o];
                        if (g !== n.OPS.dependency) this[g].apply(this, a[o]); else for (const t of a[o]) {
                ...
                _scaleImage(t, e) {
                    ...
                    let i, a, r = Math.max(Math.hypot(e[0], e[1]), 1), o = Math.max(Math.hypot(e[2], e[3]), 1), l = s,
                        c = n, h = "prescale1";
                    for (; r > 2 && l > 1 || o > 2 && c > 1;) {
                        let e = l, s = c;
                        if (r > 2 && l > 1) {
                ...
                _createMaskCanvas(t) {
                    const e = this.ctx, {width: s, height: r} = t, o = this.current.fillColor,
                        l = this.current.patternFill, c = (0, i.getCurrentTransform)(e);
                    let h, d, u, p;
                    ...
                    const f = n.Util.applyTransform([0, 0], g), m = n.Util.applyTransform([s, r], g),
                        b = n.Util.normalizeRect([f[0], f[1], m[0], m[1]]), A = Math.round(b[2] - b[0]) || 1,
                        _ = Math.round(b[3] - b[1]) || 1, v = this.cachedCanvases.getCanvas("fillCanvas", A, _),
                        y = v.context, S = Math.min(f[0], m[0]), x = Math.min(f[1], m[1]);
                    y.translate(-S, -x);
                    y.transform(...g);
                    if (!u) {
                    ...
                    return {canvas: v.canvas, offsetX: Math.round(S), offsetY: Math.round(x)}
                }
                ...
                beginSMaskMode() {
                    ...
                    const t = this.ctx.canvas.width, e = this.ctx.canvas.height, s = "smaskGroupAt" + this.groupLevel,
                ...
                constructPath(t, e, s) {
                    ...
                    let o, l, c = r.x, h = r.y;
                    const d = (0, i.getCurrentTransform)(a), u = 0 === d[0] && 0 === d[3] || 0 === d[1] && 0 === d[2],
                        p = u ? s.slice(0) : null;
                    for (let s = 0, i = 0, g = t.length; s < g; s++) switch (0 | t[s]) {
                        case n.OPS.rectangle:
                            c = e[i++];
                            h = e[i++];
                            const t = e[i++], s = e[i++], g = c + t, f = h + s;
                            a.moveTo(c, h);
                            if (0 === t || 0 === s) a.lineTo(g, f); else {
                                a.lineTo(g, h);
                                a.lineTo(g, f);
                                a.lineTo(c, f)
                            }
                ...
                paintChar(t, e, s, a) {
                    const r = this.ctx, o = this.current, l = o.font, c = o.textRenderingMode,
                ...
                showText(t) {
                    ...
                    const r = e.fontSize;
                    if (0 === r) return;
                    const o = this.ctx, l = e.fontSizeScale, c = e.charSpacing, h = e.wordSpacing, d = e.fontDirection,
                        u = e.textHScale * d, p = t.length, g = s.vertical, f = g ? 1 : -1, m = s.defaultVMetrics,
                        b = r * e.fontMatrix[0],
                    ...
                    for (S = 0; S < p; ++S) {
                        ...
                        let n = !1;
                        const i = (e.isSpace ? h : 0) + c, a = e.fontChar, u = e.accent;
                        let p, v, y, E = e.width;
                        if (g) {
                            const t = e.vmetric || m, s = -(e.vmetric ? t[1] : .5 * E) * b, n = t[2] * b;
                            E = t ? -t[0] : E;
                            p = s / l;
                            v = (x + n) / l
                        } else {
                        ...
                        if (this.contentVisible && (e.isInFont || s.missingFile)) if (A && !u) o.fillText(a, p, v); else {
                            this.paintChar(a, p, v, _);
                            if (u) {
                                const t = p + r * u.offset.x / l, e = v - r * u.offset.y / l;
                ...
                showType3Text(t) {
                    const e = this.ctx, s = this.current, i = s.font, a = s.fontSize, r = s.fontDirection,
                        o = i.vertical ? 1 : -1, l = s.charSpacing, c = s.wordSpacing, h = s.textHScale * r,
                        d = s.fontMatrix || n.FONT_IDENTITY_MATRIX, u = t.length;
                    let p, g, f, m;
                    if (!(s.textRenderingMode === n.TextRenderingMode.INVISIBLE) && 0 !== a) {
                        ...
                        for (p = 0; p < u; ++p) {
                            ...
                            const r = (g.isSpace ? c : 0) + l, u = i.charProcOperatorList[g.operatorListId];
                            if (!u) {
                ...
                getColorN_Pattern(t) {
                    ...
                    if ("TilingPattern" === t[0]) {
                        const s = t[1], n = this.baseTransform || (0, i.getCurrentTransform)(this.ctx), r = {
                ...
                shadingFill(t) {
                    ...
                    if (r) {
                        const t = e.canvas, s = t.width, i = t.height, a = n.Util.applyTransform([0, 0], r),
                            o = n.Util.applyTransform([0, i], r), l = n.Util.applyTransform([s, 0], r),
                            c = n.Util.applyTransform([s, i], r), h = Math.min(a[0], o[0], l[0], c[0]),
                ...
                beginGroup(t) {
                    ...
                    const f = this.cachedCanvases.getCanvas(g, h, d), m = f.context;
                    m.scale(1 / u, 1 / p);
                    m.translate(-l, -c);
                    m.transform(...s);
                ...
                beginAnnotation(t, e, s, a, r) {
                    ...
                    if (Array.isArray(e) && 4 === e.length) {
                        ...
                        if (r && this.annotationCanvasMap) {
                            ...
                            e[2] = a;
                            e[3] = o;
                            const [r, l] = n.Util.singularValueDecompose2dScale((0, i.getCurrentTransform)(this.ctx)), {viewportScale: c} = this,
                                h = Math.ceil(a * this.outputScaleX * c), d = Math.ceil(o * this.outputScaleY * c);
                ...
                paintImageMaskXObject(t) {
                    ...
                    if (n) {
                        void 0 === n.compiled && (n.compiled = function compileType3Glyph(t) {
                            ...
                            const n = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]), i = e + 1;
                            let a, r, o, c = new Uint8Array(i * (s + 1));
                            const h = e + 7 & -8;
                            let d = new Uint8Array(h * s), u = 0;
                            ...
                            if (p > 1e3) return null;
                            const g = new Int32Array([0, i, -1, 0, -i, 0, 0, 0, 1]), f = new Path2D;
                            for (a = 0; p && a <= s; a++) {
                                let t = a * i;
                                const s = t + e;
                                for (; t < s && !c[t];) t++;
                    ...
                    const i = this._createMaskCanvas(t), a = i.canvas;
                    s.save();
                ...
                paintImageMaskXObjectRepeat(t, e, s = 0, a = 0, r, o) {
                    ...
                    for (let t = 0, i = o.length; t < i; t += 2) {
                        const i = n.Util.transform(c, [e, s, a, r, o[t], o[t + 1]]), [d, u] = n.Util.applyTransform([0, 0], i);
                ...
                paintImageMaskXObjectGroup(t) {
                    ...
                    for (const r of t) {
                        const {data: t, width: o, height: l, transform: c} = r,
                            h = this.cachedCanvases.getCanvas("maskCanvas", o, l), d = h.context;
                        d.save();
                ...
                paintInlineImageXObjectGroup(t, e) {
                    if (!this.contentVisible) return;
                    const s = this.ctx, n = t.width, i = t.height,
                ...
                getSinglePixelWidth() {
                    if (!this._cachedGetSinglePixelWidth) {
                        ...
                        if (0 === t[1] && 0 === t[2]) this._cachedGetSinglePixelWidth = 1 / Math.min(Math.abs(t[0]), Math.abs(t[3])); else {
                            const e = Math.abs(t[0] * t[3] - t[2] * t[1]), s = Math.hypot(t[0], t[2]),
                ...
                getScaleForStroking() {
                    if (!this._cachedScaleForStroking) {
                        const {lineWidth: t} = this.current, e = (0, i.getCurrentTransform)(this.ctx);
                        let s, n;
                        if (0 === e[1] && 0 === e[2]) {
                            const i = Math.abs(e[0]), a = Math.abs(e[3]);
                            if (0 === t) {
                                s = 1 / i;
                                n = 1 / a
                            } else {
                            ...
                            const i = Math.abs(e[0] * e[3] - e[2] * e[1]), a = Math.hypot(e[0], e[1]),
                ...
                rescaleAndStroke(t) {
                    const {ctx: e} = this, {lineWidth: s} = this.current, [n, a] = this.getScaleForStroking();
                    e.lineWidth = s || 1;
                    if (1 === n && 1 === a) {
                        e.stroke();
                        return
            ...
            function applyBoundingBox(t, e) {
                if (!e) return;
                const s = e[2] - e[0], n = e[3] - e[1], i = new Path2D;
                i.rect(e[0], e[1], s, n);
                t.clip(i)
            }
                ...
                getPattern(t, e, s, r) {
                    ...
                    if (r === a.STROKE || r === a.FILL) {
                        const a = e.current.getClippedPathBoundingBox(r, (0, i.getCurrentTransform)(t)) || [0, 0, 0, 0],
                            l = Math.ceil(a[2] - a[0]) || 1, c = Math.ceil(a[3] - a[1]) || 1,
                            h = e.cachedCanvases.getCanvas("pattern", l, c, !0), d = h.context;
            ...
            function drawTriangle(t, e, s, n, i, a, r, o) {
                const l = e.coords, c = e.colors, h = t.data, d = 4 * t.width;
                let u;
                if (l[s + 1] > l[n + 1]) {
                    u = s;
                    s = n;
                ...
                const p = (l[s] + e.offsetX) * e.scaleX, g = (l[s + 1] + e.offsetY) * e.scaleY,
                    f = (l[n] + e.offsetX) * e.scaleX, m = (l[n + 1] + e.offsetY) * e.scaleY,
                    b = (l[i] + e.offsetX) * e.scaleX, A = (l[i + 1] + e.offsetY) * e.scaleY;
                if (g >= A) return;
                const _ = c[a], v = c[a + 1], y = c[a + 2], S = c[r], x = c[r + 1], E = c[r + 2], C = c[o],
                    P = c[o + 1], T = c[o + 2], w = Math.round(g), k = Math.round(A);
                let R, M, F, D, I, O, L, N;
                for (let t = w; t <= k; t++) {
                    if (t < m) {
                        let e;
                    ...
                    L = v - (v - P) * e;
                    N = y - (y - T) * e;
                    const s = Math.round(Math.min(R, I)), n = Math.round(Math.max(R, I));
                    let i = d * t + 4 * s;
                    for (let t = s; t <= n; t++) {
                        e = (R - t) / (R - I);
                        e < 0 ? e = 0 : e > 1 && (e = 1);
            ...
            function drawFigure(t, e, s) {
                const n = e.coords, i = e.colors;
                let a, r;
                switch (e.type) {
                    case"lattice":
                        const o = e.verticesPerRow, l = Math.floor(n.length / o) - 1, c = o - 1;
                        for (a = 0; a < l; a++) {
                            let e = a * o;
                            for (let a = 0; a < c; a++, e++) {
            ...
            class MeshShadingPattern extends BaseShadingPattern {
                ...
                _createMeshCanvas(t, e, s) {
                    const n = Math.floor(this._bounds[0]), i = Math.floor(this._bounds[1]),
                        a = Math.ceil(this._bounds[2]) - n, r = Math.ceil(this._bounds[3]) - i,
                        o = Math.min(Math.ceil(Math.abs(a * t[0] * 1.1)), 3e3),
                        l = Math.min(Math.ceil(Math.abs(r * t[1] * 1.1)), 3e3), c = a / o, h = r / l, d = {
                            coords: this._coords,
                            colors: this._colors,
                            offsetX: -n,
                            offsetY: -i,
                            scaleX: 1 / c,
                            scaleY: 1 / h
                        }, u = o + 4, p = l + 4, g = s.getCanvas("mesh", u, p, !1), f = g.context,
                ...
                getPattern(t, e, s, r) {
                    applyBoundingBox(t, this._bbox);
                    let o;
                    if (r === a.SHADING) o = n.Util.singularValueDecompose2dScale((0, i.getCurrentTransform)(t)); else {
            ...
            class TilingPattern {
                ...
                createPatternCanvas(t) {
                    const e = this.operatorList, s = this.bbox, a = this.xstep, r = this.ystep, o = this.paintType,
                        l = this.tilingType, c = this.color, h = this.canvasGraphicsFactory;
                    (0, n.info)("TilingType: " + l);
                    const d = s[0], u = s[1], p = s[2], g = s[3], f = n.Util.singularValueDecompose2dScale(this.matrix),
                        m = n.Util.singularValueDecompose2dScale(this.baseTransform), b = [f[0] * m[0], f[1] * m[1]],
                        A = this.getSizeAndScale(a, this.ctx.canvas.width, b[0]),
                        _ = this.getSizeAndScale(r, this.ctx.canvas.height, b[1]),
                        v = t.cachedCanvases.getCanvas("pattern", A.size, _.size, !0), y = v.context,
                    ...
                    S.endDrawing();
                    return {canvas: v.canvas, scaleX: A.scale, scaleY: _.scale, offsetX: x, offsetY: E}
                }
            ...
            e.applyMaskImageData = function applyMaskImageData({
                ...
                const l = n.FeatureTest.isLittleEndian ? 4278190080 : 255, [c, h] = o ? [0, l] : [l, 0], d = a >> 3,
                    u = 7 & a, p = t.length;
            ...
            var n = s(1);
            const i = 1, a = 2, r = 1, o = 2, l = 3, c = 4, h = 5, d = 6, u = 7, p = 8;
            ...
            e.MessageHandler = class MessageHandler {
                constructor(t, e, s) {
                    ...
                    this._onComObjOnMessage = t => {
                        ...
                        if (e.callback) {
                            const t = e.callbackId, s = this.callbackCapabilities[t];
                            if (!s) throw new Error(`Cannot resolve callback ${t}`);
                            delete this.callbackCapabilities[t];
                            if (e.callback === i) s.resolve(e.data); else {
                ...
                sendWithPromise(t, e, s) {
                    const i = this.callbackId++, a = (0, n.createPromiseCapability)();
                ...
                _createStreamSink(t) {
                    const e = t.streamId, s = this.sourceName, i = t.sourceName, a = this.comObj, r = this,
                        o = this.actionHandler[t.action], d = {
                            enqueue(t, r = 1, o) {
                                ...
                                a.postMessage({sourceName: s, targetName: i, stream: c, streamId: e, chunk: t}, o)
                            },
                            close() {
                                if (!this.isCancelled) {
                                    this.isCancelled = !0;
                                    a.postMessage({sourceName: s, targetName: i, stream: l, streamId: e});
                    ...
                    new Promise((function (e) {
                        ...
                        a.postMessage({sourceName: s, targetName: i, stream: p, streamId: e, success: !0})
                    }), (function (t) {
                        a.postMessage({sourceName: s, targetName: i, stream: p, streamId: e, reason: wrapReason(t)})
                    }))
                }

                _processStreamMessage(t) {
                    const e = t.streamId, s = this.sourceName, i = t.sourceName, a = this.comObj,
                        g = this.streamControllers[e], f = this.streamSinks[e];
                    switch (t.stream) {
                        case p:
                        ...
                        case d:
                            if (!f) {
                                a.postMessage({sourceName: s, targetName: i, stream: u, streamId: e, success: !0});
                                break
                            }
                        ...
                        case r:
                            ...
                            new Promise((function (e) {
                                ...
                                a.postMessage({sourceName: s, targetName: i, stream: o, streamId: e, success: !0})
                            }), (function (t) {
                                a.postMessage({
                                    sourceName: s,
                                    targetName: i,
            ...
            e.OptionalContentConfig = class OptionalContentConfig {
                ...
                constructor(t) {
                    ...
                    if (null !== t) {
                        ...
                        if ("OFF" === t.baseState) for (const t of this.#gt.values()) t._setVisible(a, !1);
                ...
                #bt(t) {
                    ...
                    for (let i = 1; i < e; i++) {
                        const e = t[i];
                        let a;
                        if (Array.isArray(e)) a = this.#bt(e); else {
                            if (!this.#gt.has(e)) {
            ...
            e.PDFDataTransportStream = class PDFDataTransportStream {
                ...
                _onReceiveData({begin: t, chunk: e}) {
                    ...
                    if (void 0 === t) this._fullRequestReader ? this._fullRequestReader._enqueue(s) : this._queuedChunks.push(s); else {
            ...
            class XfaText {
                static textContent(t) {
                    const e = [], s = {items: e, styles: Object.create(null)};
                    !function walk(t) {
                        if (!t) return;
                        let s = null;
                        const n = t.name;
            ...
            var n = s(1), i = s(22);
            const a = require("fs"), r = require("http"), o = require("https"), l = require("url"),
                c = /^file:\/\/\/[a-zA-Z]:\//;
            ...
            class PDFNodeStreamFsRangeReader extends BaseRangeReader {
                constructor(t, e, s) {
                    ...
                    this._setReadableStream(a.createReadStream(n, {start: e, end: s - 1}))
                }
            }
        }, (t, e, s) => {
            Object.defineProperty(e, "__esModule", {value: !0});
            ...
            e.validateRangeRequestCapabilities = function validateRangeRequestCapabilities({
                ...
                const i = {allowRangeRequests: !1, suggestedLength: void 0}, a = parseInt(t("Content-Length"), 10);
            ...
            e.getFilenameFromContentDispositionHeader = function getFilenameFromContentDispositionHeader(t) {
                ...
                function textdecode(t, s) {
                    if (t) {
                        ...
                        try {
                            const i = new TextDecoder(t, {fatal: !0}), a = (0, n.stringToBytes)(s);
                            s = i.decode(a);
                            e = !1
                        } catch (t) {
                        }
            ...
            class NetworkManager {
                ...
                request(t) {
                    const e = this.getXhr(), s = this.currXhrId++, n = this.pendingRequests[s] = {xhr: e};
                    e.open("GET", this.url);
                ...
                onStateChange(t, e) {
                    ...
                    } else r ? s.onDone({begin: 0, chunk: r}) : s.onError?.(i.status)
                }
            ...
            var n = s(1), i = s(6);
            const a = 1e5, r = 30, o = .8, l = new Map;

            function getCtx(t, e) {
                let s;
                if (e && n.FeatureTest.isOffscreenCanvasSupported) s = new OffscreenCanvas(t, t).getContext("2d", {alpha: !1}); else {
            ...
            function appendText(t, e, s) {
                const i = document.createElement("span"),
                    a = {angle: 0, canvasWidth: 0, hasText: "" !== e.str, hasEOL: e.hasEOL, fontSize: 0};
                t._textDivs.push(i);
                const c = n.Util.transform(t._transform, e.transform);
                let h = Math.atan2(c[1], c[0]);
                const d = s[e.fontName];
                d.vertical && (h += Math.PI / 2);
                const u = Math.hypot(c[2], c[3]), p = u * function getAscent(t, e) {
                    const s = l.get(t);
                    if (s) return s;
                    const n = getCtx(r, e);
                    n.font = `${r}px ${t}`;
                    const i = n.measureText("");
                    let a = i.fontBoundingBoxAscent, c = Math.abs(i.fontBoundingBoxDescent);
                    if (a) {
                        const e = a / (a + c);
                        l.set(t, e);
                ...
                const m = "calc(var(--scale-factor)*", b = i.style;
                ...
                let A = !1;
                if (e.str.length > 1) A = !0; else if (" " !== e.str && e.transform[0] !== e.transform[3]) {
                    const t = Math.abs(e.transform[0]), s = Math.abs(e.transform[3]);
            ...
            function layout(t) {
                const {div: e, scale: s, properties: n, ctx: i, prevFontSize: a, prevFontFamily: r} = t, {style: o} = e;
                let l = "";
                if (0 !== n.canvasWidth && n.hasText) {
                    const {fontFamily: c} = o, {canvasWidth: h, fontSize: d} = n;
                    if (a !== d || r !== c) {
                        i.font = `${d * s}px ${c}`;
                        t.prevFontSize = d;
                        t.prevFontFamily = c
            ...
            class TextLayerRenderTask {
                ...
                _processItems(t, e) {
                    for (const s of t) if (void 0 !== s.str) {
                ...
                _render() {
                    ...
                    t.promise.then((() => {
                        ...
                        !function render(t) {
                            ...
                            if (e.length > a) s.resolve(); else {
                                if (!t._isReadableStream) for (const s of e) t._layoutText(s);
                                s.resolve()
                            }
                        }(this)
            ...
            var n = s(1), i = s(5), a = s(28), r = s(29), o = s(6);
            ...
            class AnnotationEditorLayer {
                ...
                addInkEditorIfNeeded(t) {
                    ...
                    if (!t) for (const t of this.#St.values()) if (t.isEmpty()) {
                        t.setInBackground();
                        return
                    }
                ...
                #Tt(t) {
                    const e = this.getNextId(),
                        s = this.#kt({parent: this, id: e, x: t.offsetX, y: t.offsetY, uiManager: this.#Ct});
                    s && this.add(s);
                    return s
                }
                ...
                drop(t) {
                    const e = t.dataTransfer.getData("text/plain"), s = this.#Ct.getEditor(e);
                    if (!s) return;
                    t.preventDefault();
                    t.dataTransfer.dropEffect = "move";
                    this.#wt(s);
                    const n = this.div.getBoundingClientRect(), i = t.clientX - n.x, a = t.clientY - n.y;
            ...
            class FreeTextEditor extends a.AnnotationEditor {
                ...
                #qt() {
                    ...
                    if (this.isAttachedToDOM) s = this.div.getBoundingClientRect(); else {
                        const {currentLayer: t, div: e} = this, n = e.style.display;
                ...
                serialize() {
                    ...
                    const t = FreeTextEditor._internalPadding * this.parentScale, e = this.getRect(t, t),
            ...
            class InkEditor extends i.AnnotationEditor {
                ...
                setDimensions(t, e) {
                    const s = Math.round(t), n = Math.round(e);
                ...
                #_e(t, e) {
                    const s = this.#ve(), n = (t - s) / this.#zt, i = (e - s) / this.#Gt;
                ...
                #ye(t, e, s, n) {
                    const i = [], a = this.thickness / 2;
                    let r, o;
                    for (const l of this.paths) {
                        r = [];
                        o = [];
                        for (let i = 0, c = l.length; i < c; i++) {
                            const [c, h, d, u] = l[i], p = t * (c[0] + e) + a, g = n - t * (c[1] + s) - a,
                                f = t * (h[0] + e) + a, m = n - t * (h[1] + s) - a, b = t * (d[0] + e) + a,
                                A = n - t * (d[1] + s) - a, _ = t * (u[0] + e) + a, v = n - t * (u[1] + s) - a;
                            if (0 === i) {
                                r.push(p, g);
                                o.push(p, g)
                            }
                ...
                #Se(t, e, s, n, i, a, r, o, l, c) {
                    if (this.#xe(t, e, s, n, i, a, r, o)) c.push(r, o); else {
                        for (let h = 1; h < l - 1; h++) {
                            const d = h / l, u = 1 - d;
                            let p = d * t + u * s, g = d * e + u * n, f = d * s + u * i, m = d * n + u * a;
                            p = d * p + u * f;
                            g = d * g + u * m;
                            f = d * f + u * (d * i + u * r);
                            m = d * m + u * (d * a + u * o);
                ...
                #xe(t, e, s, n, i, a, r, o) {
                    const l = (3 * s - 2 * t - r) ** 2, c = (3 * n - 2 * e - o) ** 2, h = (3 * i - t - 2 * r) ** 2,
                        d = (3 * a - e - 2 * o) ** 2;
                ...
                #Ee() {
                    ...
                    for (const a of this.paths) for (const [r, o, l, c] of a) {
                ...
                static deserialize(t, e, s) {
                    ...
                    i.opacity = t.opacity;
                    const [a, r] = i.pageDimensions, l = i.width * a, c = i.height * r, h = i.parentScale,
                        d = t.thickness / 2;
                    i.#Ht = l / c;
                    i.#Kt = !0;
                    i.#te = Math.round(l);
                    ...
                    for (const {bezier: e} of t.paths) {
                        const t = [];
                        i.paths.push(t);
                        let s = h * (e[0] - d), n = h * (c - e[1] - d);
                        for (let i = 2, a = e.length; i < a; i += 6) {
                            const a = h * (e[i] - d), r = h * (c - e[i + 1] - d), o = h * (e[i + 2] - d),
                                l = h * (c - e[i + 3] - d), u = h * (e[i + 4] - d), p = h * (c - e[i + 5] - d);
                ...
                serialize() {
                    if (this.isEmpty()) return null;
                    const t = this.getRect(0, 0), e = this.rotation % 180 == 0 ? t[3] - t[1] : t[2] - t[0],
            ...
            function generateAndReport(t, e, s, n, i, a) {
                ...
                r = function generateBezier(t, e, s, n) {
                    var i, a, r, o, l, c, h, d, u, p, g, f, m, b, A, _, v, y = t[0], S = t[t.length - 1];
                    i = [y, null, null, S];
            ...
            function newtonRaphsonRootFind(t, e, s) {
                var n = maths.subtract(bezier.q(t, s), e), i = bezier.qprime(t, s), a = maths.mulMatrix(n, i),
            ...
            class bezier {
                static q(t, e) {
                    var s = 1 - e, n = maths.mulItems(t[0], s * s * s), i = maths.mulItems(t[1], 3 * s * s * e),
                        a = maths.mulItems(t[2], 3 * s * e * e), r = maths.mulItems(t[3], e * e * e);
                    return maths.addArrays(maths.addArrays(n, i), maths.addArrays(a, r))
                }

                static qprime(t, e) {
                    var s = 1 - e, n = maths.mulItems(maths.subtract(t[1], t[0]), 3 * s * s),
            ...
            t.exports = function fitCurve(t, e, s) {
                ...
                const n = t.length, i = createTangent(t[1], t[0]), a = createTangent(t[n - 2], t[n - 1]);
            ...
            var n = s(1), i = s(6), a = s(3), r = s(33), o = s(34);
            const l = 1e3, c = new WeakSet;
            ...
            class AnnotationElement {
                ...
                _createContainer(t = !1) {
                    const {data: e, page: s, viewport: i} = this, a = document.createElement("section");
                ...
                _getElementsByName(t, e = null) {
                    ...
                    if (this._fieldObjects) {
                        ...
                        if (i) for (const {page: t, id: a, exportValues: r} of i) {
                            if (-1 === t) continue;
                            if (a === e) continue;
                    ...
                    for (const n of document.getElementsByName(t)) {
                        const {exportValue: t} = n, i = n.getAttribute("data-element-id");
                        i !== e && (c.has(n) && s.push({id: i, exportValue: t, domElement: n}))
                    }
                    return s
                }
            }
            ...
            class LinkAnnotationElement extends AnnotationElement {
                ...
                _bindResetFormAction(t, e) {
                    ...
                    if (this._fieldObjects) t.onclick = () => {
                        s?.();
                        const {fields: t, refs: i, include: a} = e, r = [];
                        if (0 !== t.length || 0 !== i.length) {
                            ...
                            for (const t of Object.values(this._fieldObjects)) for (const s of t) e.has(s.id) === a && r.push(s)
            ...
            class WidgetAnnotationElement extends AnnotationElement {
                ...
                _setTextStyle(t) {
                    const e = ["left", "center", "right"], {fontColor: s} = this.data.defaultAppearanceData,
                        i = this.data.defaultAppearanceData.fontSize || 9, a = t.style;
                    let r;
            ...
            class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    if (this.renderForms) {
                        ...
                        const r = {userValue: i, formattedValue: null, lastCommittedValue: null, commitKey: 1};
                        if (this.data.multiLine) {
                        ...
                        if (this.enableScripting && this.hasJSActions) {
                            ...
                            s.addEventListener("updatefromsandbox", (s => {
                                const n = {
                                    value(s) {
                                        ...
                                        const {charLimit: n} = s.detail, {target: i} = s;
                                        if (0 === n) {
                            ...
                            this.data.actions?.Keystroke && s.addEventListener("beforeinput", (t => {
                                ...
                                const {data: s, target: n} = t, {value: i, selectionStart: a, selectionEnd: o} = n;
                                let l = a, c = o;
                                switch (t.inputType) {
            ...
            class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    const t = this.annotationStorage, e = this.data.id,
                        s = t.getValue(e, {value: this.data.fieldValue}), n = document.createElement("select");
                    c.add(n);
                    ...
                    const getValue = t => {
                        const e = t ? "value" : "textContent", {options: s, multiple: i} = n;
                    ...
                    if (this.enableScripting && this.hasJSActions) {
                        n.addEventListener("updatefromsandbox", (s => {
                            const i = {
                                value(s) {
                                    a?.();
                                    const i = s.detail.value, o = new Set(Array.isArray(i) ? i : [i]);
                                    ...
                                    const i = n.options, a = s.detail.remove;
                                    i[a].selected = !1;
                                    n.remove(a);
                                    if (i.length > 0) {
                                        -1 === Array.prototype.findIndex.call(i, (t => t.selected)) && (i[0].selected = !0)
                                    }
                                    t.setValue(e, {value: getValue(!0), items: getItems(s)});
                                    r = getValue(!1)
                                }, clear(s) {
                                    ...
                                    const {index: i, displayValue: a, exportValue: o} = s.detail.insert,
                                        l = n.children[i], c = document.createElement("option");
                                    c.textContent = a;
                                    c.value = o;
                        ...
                        this._setEventListeners(n, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"], ["input", "Action"], ["input", "Validate"]], (t => t.target.value))
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                constructor(t) {
                    const {data: e} = t;
                    super(t, {isRenderable: !PopupAnnotationElement.IGNORE_TYPES.has(e.parentType) && !!(e.titleObj?.str || e.contentsObj?.str || e.richText?.str)})
                }
                ...
                render() {
                    ...
                    const e = new PopupElement({
                        ...
                        a = i[0] + this.data.parentRect[2] - this.data.parentRect[0], r = i[1], {
                            pageWidth: o,
                            pageHeight: l,
                            pageX: c,
                            pageY: h
            ...
            class PopupElement {
                ...
                render() {
                    ...
                    const s = this.color;
                    if (s) {
                        const t = .7 * (255 - s[0]) + s[0], i = .7 * (255 - s[1]) + s[1], a = .7 * (255 - s[2]) + s[2];
            ...
            class LineAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    const t = this.data, {width: e, height: s} = getRectDims(t.rect),
                        n = this.svgFactory.create(e, s, !0), i = this.svgFactory.createElement("svg:line");
            ...
            class SquareAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    const t = this.data, {width: e, height: s} = getRectDims(t.rect),
                        n = this.svgFactory.create(e, s, !0), i = t.borderStyle.width,
            ...
            class PolylineAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    for (const e of t.vertices) {
                        const s = e.x - t.rect[0], n = t.rect[3] - e.y;
                        i.push(s + "," + n)
                    }
                    i = i.join(" ");
            ...
            class InkAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    for (const e of t.inkLists) {
                        let s = [];
                        for (const n of e) {
                            const e = n.x - t.rect[0], i = t.rect[3] - n.y;
                            s.push(`${e},${i}`)
                        }
                        s = s.join(" ");
            ...
            e.XfaLayer = class XfaLayer {
                static setupStorage(t, e, s, n, i) {
                    ...
                    switch (s.name) {
                        ...
                        case"input":
                            ...
                            break;
                        case"select":
                            if (null !== a.value) for (const t of s.children) t.attributes.value === a.value && (t.attributes.selected = !0);
                            t.addEventListener("input", (t => {
                                const s = t.target.options, i = -1 === s.selectedIndex ? "" : s[s.selectedIndex].value;
                ...
                static setAttributes({html: t, element: e, storage: s = null, intent: n, linkService: i}) {
                    ...
                    for (const [e, s] of Object.entries(a)) if (null != s) switch (e) {
                        case"class":
                ...
                static render(t) {
                    const e = t.annotationStorage, s = t.linkService, i = t.xfaHtml, a = t.intent || "display",
                        r = document.createElement(i.name);
                    i.attributes && this.setAttributes({html: r, element: i, intent: a, linkService: s});
                    const o = [[i, -1, r]], l = t.div;
                    l.append(r);
                    if (t.viewport) {
            ...
            e.SVGGraphics = r;
            {
                const o = {fontStyle: "normal", fontWeight: "normal", fillColor: "#000000"},
                    l = "http://www.w3.org/XML/1998/namespace", c = "http://www.w3.org/1999/xlink",
                    h = ["butt", "round", "square"], d = ["miter", "round", "bevel"],
                    createObjectURL = function (t, e = "", s = !1) {
                        ...
                        for (let e = 0, s = t.length; e < s; e += 3) {
                            const a = 255 & t[e], r = 255 & t[e + 1], o = 255 & t[e + 2];
                            i += n[a >> 2] + n[(3 & a) << 4 | r >> 4] + n[e + 1 < s ? (15 & r) << 2 | o >> 6 : 64] + n[e + 2 < s ? 63 & o : 64]
                        }
                        return i
                    }, u = function () {
                        const t = new Uint8Array([137, 80, 78, 71, 13, 10, 26, 10]), e = 12, s = new Int32Array(256);
                        for (let t = 0; t < 256; t++) {
                            let e = t;
                        ...
                        function deflateSyncUncompressed(t) {
                            let e = t.length;
                            const s = 65535, n = Math.ceil(e / s), i = new Uint8Array(2 + e + 5 * n + 4);
                            let a = 0;
                            i[a++] = 120;
                            i[a++] = 156;
                            let r = 0;
                        ...
                        function encode(s, n, r, o) {
                            ...
                            const b = new Uint8Array([l >> 24 & 255, l >> 16 & 255, l >> 8 & 255, 255 & l, c >> 24 & 255, c >> 16 & 255, c >> 8 & 255, 255 & c, h, d, 0, 0, 0]),
                                ...
                                }(g), _ = t.length + 3 * e + b.length + A.length, v = new Uint8Array(_);
                            let y = 0;
                            v.set(t, y);
                            y += t.length;
                ...
                function opListToTree(t) {
                    let e = [];
                    const s = [];
                    for (const n of t) if ("save" !== n.fn) "restore" === n.fn ? e = s.pop() : e.push(n); else {
                ...
                e.SVGGraphics = r = class {
                    ...
                    loadDependencies(t) {
                        const e = t.fnArray, s = t.argsArray;
                        for (let t = 0, n = e.length; t < n; t++) if (e[t] === i.OPS.dependency) for (const e of s[t]) {
                            const t = e.startsWith("g_") ? this.commonObjs : this.objs, s = new Promise((s => {
                                t.get(e, s)
                            }));
                    ...
                    convertOpList(t) {
                        const e = this._operatorIdMapping, s = t.argsArray, n = t.fnArray, i = [];
                    ...
                    executeOpTree(t) {
                        for (const e of t) {
                            const t = e.fn, s = e.fnId, n = e.args;
                            switch (0 | s) {
                    ...
                    showText(t) {
                        const e = this.current, s = e.font, n = e.fontSize;
                        if (0 === n) return;
                        const a = e.fontSizeScale, r = e.charSpacing, c = e.wordSpacing, h = e.fontDirection,
                            d = e.textHScale * h, u = s.vertical, p = u ? 1 : -1, g = s.defaultVMetrics,
                            f = n * e.fontMatrix[0];
                        let m = 0;
                        for (const i of t) {
                            if (null === i) {
                            ...
                            const t = (i.isSpace ? c : 0) + r, o = i.fontChar;
                            let l, d, b, A = i.width;
                            if (u) {
                                let t;
                                const e = i.vmetric || g;
                    ...
                    setFont(t) {
                        const e = this.current, s = this.commonObjs.get(t[0]);
                        let n = t[1];
                        e.font = s;
                    ...
                    shadingFill(t) {
                        const e = this.viewport.width, s = this.viewport.height,
                            n = i.Util.inverseTransform(this.transformMatrix), a = i.Util.applyTransform([0, 0], n),
                            r = i.Util.applyTransform([0, s], n), o = i.Util.applyTransform([e, 0], n),
                            l = i.Util.applyTransform([e, s], n), c = Math.min(a[0], r[0], o[0], l[0]),
                            h = Math.min(a[1], r[1], o[1], l[1]), d = Math.max(a[0], r[0], o[0], l[0]),
                            u = Math.max(a[1], r[1], o[1], l[1]), p = this.svgFactory.createElement("svg:rect");
                    ...
                    _makeTilingPattern(t) {
                        const e = t[1], s = t[2], n = t[3] || i.IDENTITY_MATRIX, [a, r, o, l] = t[4], c = t[5],
                            h = t[6], d = t[7],
                            u = "shading" + f++, [p, g, m, b] = i.Util.normalizeRect([...i.Util.applyTransform([a, r], n), ...i.Util.applyTransform([o, l], n)]), [A, _] = i.Util.singularValueDecompose2dScale(n),
                            v = c * A, y = h * _, S = this.svgFactory.createElement("svg:pattern");
                        ...
                        const x = this.svg, E = this.transformMatrix, C = this.current.fillColor,
                            P = this.current.strokeColor, T = this.svgFactory.create(m - p, b - g);
                        this.svg = T;
                    ...
                    constructPath(t, e) {
                        ...
                        r = r.join(" ");
                        if (s.path && t.length > 0 && t[0] !== i.OPS.rectangle && t[0] !== i.OPS.moveTo) r = s.path.getAttributeNS(null, "d") + r; else {
                    ...
                    endPath() {
                        ...
                        const e = "clippath" + p++, s = this.svgFactory.createElement("svg:clipPath");
                    ...
                    paintInlineImageXObject(t, e) {
                        const s = t.width, n = t.height, i = u(t, this.forceDataSchema, !!e),
                            a = this.svgFactory.createElement("svg:rect");
                    ...
                    paintImageMaskXObject(t) {
                        ...
                        const s = this.current, n = e.width, a = e.height, r = s.fillColor;
                        s.maskId = "mask" + g++;
                    ...
                    paintFormXObjectBegin(t, e) {
                        ...
                        if (e) {
                            const t = e[2] - e[0], s = e[3] - e[1], n = this.svgFactory.createElement("svg:rect");
        ...
        (() => {
            ...
            var e = __w_pdfjs_require__(1), s = __w_pdfjs_require__(2), n = __w_pdfjs_require__(6),
                i = __w_pdfjs_require__(26), a = __w_pdfjs_require__(27), r = __w_pdfjs_require__(5),
                o = __w_pdfjs_require__(32), l = __w_pdfjs_require__(14), c = __w_pdfjs_require__(35),
